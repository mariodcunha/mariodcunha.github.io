...
marioism[4] = new Quote("Singing is like peeing. You need to start with good control; maintain the control in the right direction wherever your aiming at... towards the end, just let loose!",me);
...
marioism[12] = new Quote("We all have to die one day, so why not work with only soft copies and leave the trees alone to further our generations.",me);
...
marioism[14] = new Quote("When u watch too many movies, the appreciation of watching a single movie goes down.",me);
...
marioism[23] = new Quote("When life with all its complexities stares at you in your face, grab her and give her a tight kiss!",me);
marioism[24] = new Quote("When there's nothing to do in the world, there are always movies to watch.",me);
marioism[25] = new Quote("You can always look at a glass either half full or half empty, or you can stop looking, drink it & get on with whatever ur supposed to do!",me);
marioism[26] = new Quote("When you do something religious, think about how it pleases God, and not about how it pleases the church, temple or mosque or the priest in them.",me);
...
marioism[31] = new Quote("Inspiration is a mighty strong force. Jealousy is stronger.",me);
marioism[32] = new Quote("Among all man-made things, religion is the one which sucks the most!",me);
marioism[33] = new Quote("True friendship never dies. Whatever bullshit has come in the way. It never dies, absolutely never ever. If it was true.",me);
...
marioism[35] = new Quote("Success is like an elevator. Whether you start from the middle or bottom, you can still reach the top.",me);
...
marioism[44] = new Quote("The Members of Parliament can make laws for Members of Parliament… not for themselves.",me);
marioism[45] = new Quote("When you allocate a special day to complete a special task, it will never be completed!",me);
marioism[46] = new Quote("If you catch a bunch of thieves, there will still be an innocent person among them.",me);
marioism[47] = new Quote("Three things to gain more wisdom. Think more. Talk less. Talk less.",me);
marioism[48] = new Quote("It’s only if your comfortable to fart in the company of the other person, you are his/her true friend/soulmate. Nothing else will signify a more closer relationship, than an open fart.",me);
...
marioism[60] = new Quote("When in doubt, watch F.R.I.E.N.D.S.",me);
marioism[61] = new Quote("Every Designer must not think without a pen, paper and prototype.",me);
marioism[62] = new Quote("A Paper Rocket is the ultimate symbol of childhood, creativity, travel, imagination and design.",me);
marioism[62] = new Quote("Don’t take ‘taking for granted’, for granted.",me);
