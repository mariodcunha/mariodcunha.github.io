...
var news_dot_radius = 8;
var month_width = 100;
var month_height = 200;

//Legends and Colors
var snubbedColor = "#f4636b";
var apologizedColor = "#956db3";
var legalColor = "#47c085";
var clearedColor = "#45c6f4";
var convictedColor = "#444";

var data;

//Data Start
data = d3.csv("csv/newslinks.csv").then(function(data)
{
	
// console.log(data);
console.log(data[0].link);

var svg_area = d3.select("#axis-area").append("svg")
					.attr("width", month_width)
					.attr("height", month_height);


 var circles = svg_area.selectAll("circle").data(data);
 ...
 circles.enter().append("a")
 				...
 				.append("circle")
 					...
 					{
 						return d;
 						// console.log(function(d,i){return d;})
 					})
						.attr("cy", news_dot_radius)
						.attr("r", news_dot_radius)
						.attr("fill", snubbedColor)
...
// var circle = svg_area.append("a")
// 						   .attr("xlink:href", function(d,i)
// 						   {
// 						   		console.log(d);
// 						   })
// 						// .attr("xlink:href", "https://www.nytimes.com/2017/10/05/us/harvey-weinstein-harassment-allegations.htmlz")
// 					.append("circle")
// 						.attr("cx", news_dot_radius)
// 						.attr("cy", news_dot_radius)
// 						.attr("r", news_dot_radius)
// 						.attr("fill", snubbedColor)
// 						.attr("transform", "translate(0,"+180+")");
